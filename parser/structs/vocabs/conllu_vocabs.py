...
class SpanendVocab(CoNLLUVocab):
  _field = 'spanend'
  _conllu_idx = 8

class SpanheadVocab(CoNLLUVocab):
  _field = 'spanhead'
  _conllu_idx = 8

class ArgumentVocab(CoNLLUVocab):
  _field = 'argument'
  _conllu_idx = 8

class SpanrelVocab(CoNLLUVocab):
  _field = 'spanrel'
  _conllu_idx = 8

class PredVocab(CoNLLUVocab):
  _field = 'pred'
  _conllu_idx = 8
# =========================================================
